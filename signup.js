//validate username to be unique and username & password should be more than 4 characters.
...
if(validateCredentials(username,password)){
    ...
    Please check username & password they should be greater than 4 chars & unique!!!
  </div>`
}
}
